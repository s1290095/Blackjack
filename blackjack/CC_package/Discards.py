...
class Discards:
   ...
   def decide_bet(self):
      ...
      if true_count < 0 :
         return 5
      elif true_count >= 0 and true_count < 0.5:
         return 10
      elif true_count >= 0.5 and true_count < 1.0:
         return 50
      elif true_count >= 1.0 and true_count < 2.0:
         return 100
      elif true_count >= 2.0 and true_count < 3.0:
         return 150
      elif true_count >= 3.0 and true_count < 4.0:
         return 300
      elif true_count >= 4.0:
         return 500
